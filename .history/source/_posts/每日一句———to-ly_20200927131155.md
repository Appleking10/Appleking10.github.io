...
```
<div style="width:100%;line-height:40px;border:1px solid #333;text-align:center;margin:10px auto;" onclick="this.innerHTML=`<div class='main' style='transform:rotate(45deg);margin:30px auto;width:100px;height:100px;background:blue;'></div>`">点击这里有解释！！！</div> 